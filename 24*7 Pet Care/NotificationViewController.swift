...
class NotificationViewController: UIViewController, UNUserNotificationCenterDelegate {
    ...
    func notificationsDisabledAlert() {
        let alertController = UIAlertController(title: "You have chosen not to allow notifications.", message: "Please go to your settings if you wish to allow them.", preferredStyle: UIAlertController.Style.alert)
    ...
    @objc func activityDatePickerChanged(_ sender: UIDatePicker) {
